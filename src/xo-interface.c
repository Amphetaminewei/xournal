...
create_winMain (void)
{
  ...
  // 选项->触控笔设置->Touchscreen as Hand Tool、Pen disables Touch、Designate as Touchscreen
  ...
  //Progressive Backgrounds、打印页面规则、Legacy PDF Export、Layers in PDF Export、自动加载pdf.xoj
  ...
  gtk_tool_item_set_tooltip (GTK_TOOL_ITEM (buttonHand), tooltips, _("Hand Tool"), NULL);
